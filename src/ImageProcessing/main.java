...
public class main {
    ...
    public static final String DESTINATION_FILE = "./resource/out-many-flowers.jpg";
...
//        recolorSingleThread(originalImage, resultImage);
    ...
    public static void recolorMultiThread(BufferedImage originalImage, BufferedImage resultImage, int numberThreads) throws InterruptedException {
        List<Thread> threads =new ArrayList<>();
        int width=originalImage.getWidth();
        int height=originalImage.getHeight()/numberThreads;
    ...
    public static boolean isShadGrey(int red, int green, int blue) {
